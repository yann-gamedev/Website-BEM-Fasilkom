...
export default function Hero({ onExplore, onViewAll }) {
  ...
  return (
    <section id="beranda" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-[90vh] flex items-center">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-white dark:bg-gray-900 z-0 transition-colors duration-300"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 dark:bg-brand-900/30 border border-brand-100 dark:border-brand-800 text-brand-600 dark:text-brand-400 font-semibold text-sm mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button onClick={onViewAll} className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-white border border-gray-200 dark:border-gray-700 px-8 py-3.5 rounded-full font-semibold transition-all hover:shadow-md text-center flex items-center justify-center gap-2">
          ...
          >
            ...
            <div className="absolute inset-0 z-10 perspective-1000">
              <AnimatePresence initial={false}>
                <motion.div
                  ...
                  className="absolute inset-0 w-full h-full shadow-2xl border-4 border-white dark:border-gray-800 rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-gray-700"
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-xl z-30 flex items-center gap-4"
            >
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Total Mahasiswa</p>
